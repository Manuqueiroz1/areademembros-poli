...
export default function AIAssistantSection() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="mb-8">
        <h2 className="text-3xl font-bold text-gray-900 mb-2">Gere seu Plano de Estudos</h2>
        <p className="text-gray-600">Crie um plano personalizado de 30 dias com nossa IA especializada em ensino de inglês</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
        ...
        <div className="lg:col-span-1">
          ...
          {generatedPlan && (
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
              <h3 className="text-lg font-semibold text-gray-900 mb-4">Seu Plano Gerado</h3>
              <div className="bg-purple-50 rounded-lg p-4 mb-4">
                <h4 className="font-medium text-purple-900 mb-2">{generatedPlan.title}</h4>
              ...
              <button
                ...
                className="w-full flex items-center justify-center px-4 py-3 bg-gradient-to-r from-purple-600 to-pink-600 text-white font-semibold rounded-lg hover:from-purple-700 hover:to-pink-700 transition-all"
              >
        ...
        <div className="lg:col-span-3">
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 h-[600px] flex flex-col">
            ...
            <div className="p-4 border-b border-gray-200 flex items-center space-x-3">
              ...
              <div>
                <h3 className="font-semibold text-gray-900">Assistente Teacher Poli</h3>
                <p className="text-sm text-gray-500">Especialista em planos de estudo</p>
              </div>
            </div>
