...
export default function TeacherPoliSection() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-8">
      <div className="mb-8">
        <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-2">{t('teacherpoli.title')}</h2>
        <p className="text-sm sm:text-base text-gray-600">{t('teacherpoli.subtitle')}</p>
      </div>
      ...
      <div className="bg-gradient-to-r from-purple-600 to-pink-600 rounded-2xl p-4 sm:p-8 mb-8 text-white">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-8 items-center">
          <div>
            <h3 className="text-xl sm:text-3xl font-bold mb-4">{t('teacherpoli.chatTitle')}</h3>
            <p className="text-purple-100 mb-6 text-sm sm:text-lg">{t('teacherpoli.chatDescription')}</p>
            <div className="flex flex-col gap-3 sm:gap-4">
              ...
              >
                <span className="hidden sm:inline">{t('teacherpoli.enterButton')}</span>
                <span className="sm:hidden">{t('teacherpoli.enterButtonShort')}</span>
              ...
              <button className="inline-flex items-center justify-center px-4 sm:px-6 py-3 border-2 border-white text-white font-semibold text-sm sm:text-base rounded-lg hover:bg-white hover:text-purple-600 transition-colors">
                <span className="hidden sm:inline">{t('teacherpoli.demo')}</span>
                <span className="sm:hidden">{t('teacherpoli.demoShort')}</span>
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4 sm:p-8">
        <h3 className="text-xl sm:text-2xl font-bold text-gray-900 mb-2 text-center">{t('teacherpoli.quickAccess')}</h3>
        <p className="text-sm sm:text-base text-gray-600 text-center mb-6 sm:mb-8">{t('teacherpoli.quickAccessDesc')}</p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6">
          ...
          >
            <div className="text-center">
              ...
              <p className="text-xs sm:text-sm text-gray-600">{t('teacherpoli.input')}</p>
            </div>
          </a>
          ...
          >
            <div className="text-center">
              ...
              <p className="text-xs sm:text-sm text-gray-600">{t('teacherpoli.writing')}</p>
            </div>
          </a>
          ...
          >
            <div className="text-center">
              ...
              <p className="text-xs sm:text-sm text-gray-600">{t('teacherpoli.roleplay')}</p>
            </div>
          </a>
        </div>
        ...
        <div className="grid grid-cols-1 gap-4 sm:gap-6 mt-4 sm:mt-6 max-w-md mx-auto">
          ...
          >
            <div className="text-center">
              ...
              <p className="text-xs sm:text-sm text-gray-600">{t('teacherpoli.speaking')}</p>
            </div>
          </a>
        </div>
      </div>
